...
@RestController
// 各自写代码的时候，把/lwn_1改为【/拼音名】，用于后面作为路径反向代理的时候区分不同人的代码
// @RequestMapping表示的含义：URL跟控制器的关系映射
@RequestMapping("/lwn_1/weixin/receiver")
...
//		}
		...
		// 使用默认的序列化程序来实现序列化
		inMessageTemplate.convertAndSend("lwn_1_" + inMessage.getMsgType(), inMessage);
...
//
//					String channel = "lwn_1_" + inMessage.getMsgType();
//
//					// 消息内容要自己序列化才能放入队列中
